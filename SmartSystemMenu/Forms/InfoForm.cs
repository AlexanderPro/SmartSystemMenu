...
namespace SmartSystemMenu.Forms
{
    partial class InfoForm : Form
    {
        ...
        private void InitializeControls(WindowInfo windowInfo, LanguageSettings settings)
        {
            ...
            txtWindowPosition.Text = string.Format("{0}, {1}", windowInfo.Size.Left, windowInfo.Size.Top);
            ...
            txtExtendedFrameBounds.Text = string.Format("{0} {1} {2} {3}", windowInfo.FrameBounds.Top, windowInfo.FrameBounds.Right, windowInfo.FrameBounds.Bottom, windowInfo.FrameBounds.Left);
