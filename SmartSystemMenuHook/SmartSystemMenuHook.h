...
#define WM_SSM_HOOK_CALLWNDPROC             WM_APP + 0x0206
#define WM_SSM_HOOK_CALLWNDPROC_PARAMS      WM_APP + 0x0207
#define WM_SSM_HOOK_GETMSG                  WM_APP + 0x0208
#define WM_SSM_HOOK_GETMSG_PARAMS           WM_APP + 0x0209
#define WM_SSM_HOOK_KEYBOARD                WM_APP + 0x020A
#define WM_SSM_HOOK_KEYBOARD_REPLACED       WM_APP + 0x020B
#define WM_SSM_HOOK_KEYBOARDLL              WM_APP + 0x020C
#define WM_SSM_HOOK_KEYBOARDLL_REPLACED     WM_APP + 0x020D
#define WM_SSM_HOOK_MOUSE                   WM_APP + 0x020E
#define WM_SSM_HOOK_MOUSE_REPLACED          WM_APP + 0x020F
#define WM_SSM_HOOK_MOUSELL                 WM_APP + 0x0210
#define WM_SSM_HOOK_MOUSELL_REPLACED        WM_APP + 0x0211
#define WM_SSM_HOOK_HSHELL_WINDOWCREATED    WM_APP + 0x0212
#define WM_SSM_HOOK_HSHELL_WINDOWDESTROYED  WM_APP + 0x0213
